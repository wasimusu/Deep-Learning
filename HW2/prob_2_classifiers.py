...
if __name__ == '__main__':
    ...
    plt.title('Error as a function of k with 5 fold cross validation')
    plt.xlabel('k')
    plt.ylabel('Misclassification (0-1)')
    plt.show()
    ...
    plt.title('Error as a function of k with leave one out cross validation')
    plt.xlabel('k')
    plt.ylabel('Misclassification (0-1)')
    plt.show()
